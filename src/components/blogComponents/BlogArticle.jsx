...
const BlogArticle = ({ blog }) => {
    ...
    return (
        <div className='w-full px-4 md:px-20 lg:px-32 grid place-items-center pt-28 pb-14'>
            ...
            <h2 className='font-Raleway text-[1.05rem] tracking-wide mt-1'>
                {blog.subtitle}
            </h2>
            ...
            <div className='w-full drop-shadow-sm mt-7'>
                <img
                    src={blog.img2}
            ...
            <button
                type='button'
                className='w-fit mr-auto mt-5 px-[.8rem] py-[.2rem] bg-zinc-900 text-white rounded-lg shadow-sm transition-colors
