...
const NavItemMenu = ({ navData, hideMenu }) => {
    return (
        <div className=
            {
                !hideMenu ?
                    `absolute w-full lg:w-fit -bottom-[7.4rem] lg:static grid grid-cols-3 gap-4 place-items-center lg:flex
        ...
        >
            <div className='absolute grid place-items-center top-24 bg-white w-full py-5 lg:py-0 lg:w-fit
