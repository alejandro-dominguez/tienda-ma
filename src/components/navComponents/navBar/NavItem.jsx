...
const NavItem = ({ navItem }) => {
    return (
        <NavLink
            to={navItem.url}
            className="relative block py-[.4rem] px-0 lg:py-6 lg:px-3 after:block after:content-[''] after:absolute
            lg:after:bottom-[1.35rem] after:h-[3px] after:translate-x-1/2 after:right-1/2 after:bg-red-500/60 lg:after:w-2/3
